 ...
 * the pivot element into the left position of the pivot element, and we reloate
 * original left indexed element to the right of the new pivot position
 ...
 * and then repeatedly decrease the gap and then eventually sort adjcent pair,
