...
void levelTraversalCallback(struct TreeNode *node, int pos, int level,
                            int *stop, void *data) {
  printf("---- level = %d, pos = %d, val = %d\n", level, pos, node->val);
}

void nextNodeOnSameLevelCallback(struct TreeNode *node, int pos, int level,
                                 int *stop, void *data) {
...
void findNextNodeOnSameLevel(struct TreeNode *root, int val) {
  ...
  traverseTreeNodeInLevelLeftToRightOrder(root, nextNodeOnSameLevelCallback,
                                          &data);
...
void printTreeNodeOnReverseOrderLevelCallback(struct TreeNode *node, int pos,
                                              int level, int *stop,
                                              void *data) {
...
void printTreeNodeOnReverseOrderLevel(struct TreeNode *root) {
  ...
  traverseTreeNodeInLevelLeftToRightOrder(
      root, printTreeNodeOnReverseOrderLevelCallback, &data);
...
void traversalToFindLargestBST(struct TreeNode *node, int pos, int level,
                               int *stop, void *data) {
...
void printTheLargestBSTInBinaryTree(struct TreeNode *root) {
  ...
  traverseTreeNodeInLevelLeftToRightOrder(root, traversalToFindLargestBST,
                                          &data);
  printf("the largest BST in binary tree is %d\n", data.size);
}

void traversalInTreeBoundary(struct TreeNode *node, int pos, int *stop,
                             void *data) {
  printf("%d ", node->val);
}

void traversalInVerticalAxisLevel(struct TreeNode *node, int pos, int axis,
                                  int *stop, void *data) {
  int *lastAxis;
...
void printNodeInVerticalAxisLevel(struct TreeNode *root) {
  ...
  traverseTreeNodeInVerticalOrderTopDown(root, traversalInVerticalAxisLevel,
                                         &axis);
  printf("\n");
}
...
void printNodeInDiagonalAxisLevel(struct TreeNode *root) {
  ...
  traverseTreeNodeInDiagonalWithAxisLevel(root, traversalInVerticalAxisLevel,
                                          &axis);
  printf("\n");
}

void traversalInVerticalAxisLevelAndSumValues(struct TreeNode *node, int pos,
                                              int axis, int *stop, void *data) {
...
void printSumValuesInDiagonalAxisLevel(struct TreeNode *root) {
  ...
  list = NULL;
  traverseTreeNodeInDiagonalWithAxisLevel(
      root, traversalInVerticalAxisLevelAndSumValues, &list);
